...
:-----------|:------------|:-------------|:-------------|:-------------|:-------------|:-------------|:-------------|:-------------------------------------|
[appfog](https://www.ctl.io/appfog/) | 0.4.12, 0.6.17, 0.8.14, 0.10.22 | No | Yes, custom domains in paid plan only | | [appfog](https://github.com/appfog) | Free Signups suspended | Yes – monthly subscriptions and enterprise support available | General Availability
...
[EvenNode](http://www.evennode.com) | 0.8.x, 0.9.x, 0.10.x, 0.11.x, 4.x.x, 5.x.x | Yes | Yes |  |  |  | Starting at $8/month | Runs on AWS 
...
[IBM Bluemix](http://bluemix.net) | [v0.10.21, v0.10.25, v0.10.26 and v0.10.28](https://www.ng.bluemix.net/docs/#starters/nodejs/index.html#deploynodejsapp) | Yes, 30-days free trial | Yes | | [IBM-Bluemix](https://github.com/IBM-Bluemix) | Yes | Yes | Based on Cloud Foundry |
...
[Xervo](https://help.xervo.io/) | 0.2.x - 0.11.x | Yes | Yes | #modulus | [OnModulus](https://github.com/onmodulus) | $15 free credits | $0.02/hour per instance | Live on AWS
[NodeChef](https://nodechef.com) | All versions supported | Yes | Yes |  |
...
[OpenShift](https://openshift.redhat.com/) | 0.6.20 [or any other](https://blog.openshift.com/any-version-of-nodejs-you-want-in-the-cloud-openshift-does-it-paas-style/)| Yes (preview) | Yes | #openshift | [openshift](https://github.com/openshift) | Yes | | Open
...
* [DigitalOcean Node JS One-Click](https://www.digitalocean.com/products/one-click-apps/node-js/) - $5/mo SSD Cloud Server with NodeJS and NPM pre-installed, regions: NYC, SFO, Toronto, Amsterdam, London, Bangalore, Singapore, Frankfurt
...
* [Webbynode](http://www.webbynode.com) - [setup guide](http://blog.dtrejo.com/nodejs-for-server-newbs) - [deployment guide](http://guides.webbynode.com/articles/rapidapps/nodejs.html) - [screencast](http://vimeo.com/15406437) - Servers shutdown 3/31/2016
